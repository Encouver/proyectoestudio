 ...
 class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('is_active, is_disabled', 'default', 'setOnEmpty'=>true, 'value'=>false),
			array('email_verified', 'default', 'setOnEmpty'=>true, 'value'=>false, 'on' => 'search'),
			array('activation_key, created_on, updated_on, last_visit_on, password_set_on', 'default', 'setOnEmpty' => true, 'value' => null, 'on' => 'search'),
